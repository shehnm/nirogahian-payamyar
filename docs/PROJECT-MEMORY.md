...
**تلگرام:** داخل خود Payamyar (تب پیام‌رسان‌های خارجی) — در scope کار بعدی، نه افزونه جدا.
...
### کارهای باز (۱۴۰۵/۰۴/۰۸)

| کار | وضعیت |
|-----|--------|
| تلگرام (تب خارجی Payamyar) | درخواست کارفرما — هنوز تست/رفع نشده |
| حذف staging.nirogahian.ir | درخواست کارفرما — DirectAdmin |
| cleanup پروداکشن | WP_DEBUG خاموش، diag حذف، پست‌های تست |

جزئیات: **`docs/HANDOFF.md`**
